...
mission_picture_1 = Picture(app, image="mission1.png", width=450, height=300, visible=False)
mission_picture_2 = Picture(app, image="mission2.png", width=450, height=300, visible=False)
mission_picture_3 = Picture(app, image="mission3.png", width=450, height=300, visible=False)
tellolock = Lock()
...
tellostatusthread = Thread(target=lambda: switch_status(tello, controller, tellolock, autonomous_text, mission_text, mission_picture_1, mission_picture_2, mission_picture_3), daemon=True)
